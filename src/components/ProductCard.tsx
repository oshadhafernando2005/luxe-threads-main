  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Heart className={cn("h-4.5 w-4.5", faved ? "fill-coral text-coral" : "text-foreground")} />
        </button>
      </Link>
      ...
      <div className="space-y-2.5 p-3 sm:p-4">
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          <button
            type="button"
            onClick={() => {
              add(product, product.sizes[Math.floor(product.sizes.length / 2)] ?? "M", product.colors[0] ?? "Black");
